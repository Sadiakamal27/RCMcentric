    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#10153a] py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white">
          {/* Example Benefit - repeat for each benefit */}
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">1</div>
          ...
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">2</div>
          ...
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">3</div>
          ...
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">4</div>
            <h3 className="font-semibold mb-2">Denial Management</h3>
            <p className="text-sm">
          ...
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">5</div>
          ...
          <div>
            <div className="text-5xl font-extrabold text-blue-950 mb-2">6</div>
